...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\TmsPamyraOrder>
 */
class TmsPamyraOrderFactory extends Factory
{
    /**
    ...
    {
        return [
            'order_id' => $this->faker->unique()->numberBetween(11, config('constants.numberOfDbRecords')),
            'calculation_model_name' => $this->faker->word,
            'order_number' => $this->faker->unique()->numerify('#######'),
            'order_pdf' => $this->faker->url,
            'payment_method' => $this->faker->randomElement(TmsOrder::PAYMENT_METHODS),
