...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tms_emons_invoices', function (Blueprint $table) {
            ...
            $table->string('customer')->required()->comment('The customer name.');
            ...
            $table->string('receiver')->required()->comment('The receiver name.');
            ...
            $table->boolean('is_correct')->default(null)->comment('This will be set to null by default. Null means that the netto_price is not checked yet. When the netto_price is checked, the value of this column will be true, if all is OK, and false if the price is wrong.');
            $table->timestamps();
        });
    }
