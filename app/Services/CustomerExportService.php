...
class CustomerExportService
{
    ...
    public function exportCustomers()
    {
        ...
        foreach ($customers as $customer) {        
            ...
            {
                $arrTexts[] = ('skipped: ' . $customer->id . json_encode($customer->updated_at) . ' ' . json_encode($customer->exported_at) . ' ' . json_encode($customersAndAddresses->updated_at) . ' ' . json_encode($customersAndAddresses->exported_at) . PHP_EOL);
                continue;
            }            
        ...
        $message['exportedIds'] = $this->exportedIds;
        $message['skipped'] = $arrTexts;
     ...
     * @param \App\Models\TmsCustomer $customer
     * @param \App\Models\TmsAddress $customersAndAddresses
