...
class CargoOrderRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'start_address_id' => 'required|integer|exists:tms_addresses,id',
            'target_address_id' => 'required|integer|exists:tms_addresses,id',
