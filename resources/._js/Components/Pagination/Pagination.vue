<template>
    <nav class="z-0 flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0"
        ...
        <ul class="inline-flex items-stretch -space-x-px border rounded-md border-primary-700 text-corporate-700">
            ...
            <li v-else>
                <span class="grid p-3 leading-none text-gray-400 cursor-default place-items-center min-w-fit">
                <el-icon><DArrowLeft /></el-icon>
                </span>
            </li>
