<script setup>
    ...
    const defaultInputClass = '' + 'rounded-md '  + 'w-full ' + 'peer ' + (props.field.tooltipText && props.field.tooltipText !== '' ? 'pr-8' : 'pr-0') + 'text-[15px] ' + 'text-black ' + 'border-gray-300 ' + 'focus:border-primary-700 ' + 'ring-0 ' + 'focus:ring-0 ';
