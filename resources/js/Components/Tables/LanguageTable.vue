                                    ...
                                    <div :id="'actions-dropdown-' + entry.id"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li v-for="action in actions">
                                                <a :href="route('language.edit', entry.lang )"
...
// RESET HEADERS
// sessionStorage.removeItem('language-table-headers')

const storedHeaders = sessionStorage.getItem('language-table-headers')
var _headers;
...
const updateListedItems = (key, value) => {
    ...
    sessionStorage.setItem('language-table-headers', JSON.stringify(_headers.value))
}
