...
<ol class="relative border-gray-200 border-s dark:border-gray-700">                  
    <li v-for="item,index in content.history" class="mb-10 ms-6">            
        <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
            <img class="rounded-full shadow-lg" src="https://getavataaars.com/?accessoriesType=Wayfarers&avatarStyle=Circle&clotheType=CollarSweater&eyeType=Happy&eyebrowType=SadConcernedNatural&facialHairType=BeardMedium&hairColor=PastelPink&mouthType=Sad&skinColor=Tanned&topType=ShortHairDreads01" alt="Bonnie image"/>
        </span>
