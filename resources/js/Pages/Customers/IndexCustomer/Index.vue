<template>
    ...
    <TableWithActions :actions="['edit', 'show']" v-model:paginationData="data.paginationData" @getData="getData" :title="$t('labels.customers')" :data="data.customers" :headers="headers"/>
    <!--
    <Card>
