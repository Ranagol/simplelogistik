<template>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="grid h-screen max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
            <div class="w-full place-self-center lg:col-span-6">
                <div class="p-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:max-w-xl sm:p-8">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-300">
                        {{ $t('login.description') }} <span v-if="canRegister">{{ $t('labels.ask-login') }} <a href="#"
                                class="font-medium text-primary-600 hover:underline dark:text-primary-500">{{
                                    $t('labels.signup') }}</a>.</span>
                    </p>
                    <form class="mt-4 space-y-6 sm:mt-6" @submit.prevent="submit">
                        ...
                        <div class="grid gap-6 sm:grid-cols-1">
                            <button type="submit"
                                class="w-full text-white dark:text-white bg-primary-500 hover:bg-primary-400 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">{{
                                    $t('button.login') }}</button>
                        </div>
                        <div class="flex items-center" v-if="hasForeignAuthLayer">
                            <div class="w-full h-0.5 bg-gray-200 dark:bg-gray-700"></div>
                            <div class="px-5 text-center text-gray-500 dark:text-gray-400">or</div>
                            <div class="w-full h-0.5 bg-gray-200 dark:bg-gray-700"></div>
                        </div>
                        <div class="space-y-3">
                            <a v-if="signInWithGoogle" href="#"
